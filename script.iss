...
#define WorkspacePath GetEnv("GITHUB_WORKSPACE")
#if WorkspacePath == ""
  #define WorkspacePath "D:\a\uxplay-windows-mcp\uxplay-windows-mcp"
#endif
...
SetupIconFile={#WorkspacePath}\icon.ico
Compression=lzma
...
[Files]
Source: "{#WorkspacePath}\dist\uxplay-windows\uxplay-windows.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#WorkspacePath}\dist\uxplay-windows\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
